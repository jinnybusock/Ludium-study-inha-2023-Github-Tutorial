...
1. 싱크 포크하기 (📌)
    ...
    - 아래 화면처럼 Update branch 버튼이 보일 경우 클릭해서 싱크 포크 해야 합니다.

        ![깃_싱크_포크_1](./깃%20싱크%20포크_1.png)

    - 싱크 포크가 완료되었을 경우 Sync fork 버튼을 다시 클릭해보면 아래 화면처럼 보입니다.
...
4. 풀 리퀘스트 요청 하기 (📌)
    ...
    풀 리퀘스트 요청이 완료되었습니다. 만약 여기까지 해냈다면 정말 고생하셨어요. 이제 저한테 알려주시면 깃허브 이메일을 알려주시면 중심 레포지터리의 공동 작업자로 초대해드리겠습니다.
